...
import { Card, Row, Col, Spinner, Button, Badge, Table } from 'react-bootstrap';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setPendingItems({
          appointments: pendingAppointmentsRes.data.complaints || [],
    ...
    <div className="mt-4">
      ...
      <Row className="mb-4">
        <Col>
          ...
          <p className="text-muted">SuperAdmin Dashboard - Complete system overview and management</p>
        </Col>
      </Row>
        ...
        <Col md={3} className="mb-3">
          <Card className="text-center border-primary">
            <Card.Body>
              ...
              <small className="text-muted">Total registered patients</small>
            </Card.Body>
          </Card>
        </Col>
        <Col md={3} className="mb-3">
            ...
            <Card.Body>
              <Row>
                <Col md={3} className="mb-2">
                  <Button variant="primary" className="w-100" as={Link} to="/users">
                    <i className="fas fa-user-plus me-2"></i>
                    Manage Users
                  </Button>
                </Col>
                <Col md={3} className="mb-2">
                  <Button variant="success" className="w-100" as={Link} to="/patients/new">
                    <i className="fas fa-user-plus me-2"></i>
                    Add Patient
                  </Button>
                </Col>
              ...
              <Table striped bordered hover size="sm">
                <tbody>
                  <tr>
                    ...
                    <td><Badge bg="danger">SuperAdmin</Badge></td>
                  </tr>
                  <tr>
